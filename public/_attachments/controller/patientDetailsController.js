...
function displayUploadedMedication(start,end,data) {
  ...
  for(var i=start;i<end;i++){
    output.push('<tr>');
      ...
      output.push('<td><a class="dwnld-hover mrgright1" target="blank" href="'+url+'" target="blank"><span doc_id='+data.rows[i].id+' class="label label-warning">View</span></a><a class="dwnld-hover" href="'+url+'" target="blank" download><span doc_id='+data.rows[i].id+' class="label label-warning">Download</span></a></td>');
    output.push('</tr>');
  }
